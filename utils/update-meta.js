...
function updateGHmeta(meta) {
    return __awaiter(this, void 0, void 0, function () {
        var ghContext, owner, repoName, Octokit, octakit, _a, replaceAllTopics, update;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ghContext = (_b = process.env.REPO_META.split("/")) !== null && _b !== void 0 ? _b : ["", ""];
                    owner = ghContext[0];
                    repoName = ghContext[1];
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("@octokit/rest"); })];
                case 1:
                    Octokit = (_c.sent()).Octokit;
